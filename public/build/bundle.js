...
var app = (function () {
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			span0 = element("span");
    			span0.textContent = "Dom's To-Do List";
    			t1 = space();
    			span1 = element("span");
    			t2 = text(/*completedItemCount*/ ctx[1]);
    			t3 = text("/");
    			t4 = text(/*itemCount*/ ctx[0]);
    			add_location(span0, file, 21, 4, 466);
    			add_location(span1, file, 22, 4, 500);
    			attr_dev(div, "class", "header svelte-1uq1fzm");
    			add_location(div, file, 20, 0, 441);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input0, "class", "text-input svelte-1e9mu6b");
    			attr_dev(input0, "type", "text");
    			input0.readOnly = /*completed*/ ctx[1];
    			add_location(input0, file$1, 43, 4, 870);
    			attr_dev(input1, "class", "completed-checkbox svelte-1e9mu6b");
    			attr_dev(input1, "type", "checkbox");
    			add_location(input1, file$1, 51, 4, 1105);
    			attr_dev(div, "class", "item svelte-1e9mu6b");
    			toggle_class(div, "completed", /*completed*/ ctx[1]);
    			add_location(div, file$1, 42, 0, 831);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(input0, "blur", /*blur_handler*/ ctx[5], false, false, false),
    ...
    class Item extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init(this, options, instance$1, create_fragment$1, safe_not_equal, { id: 3, text: 0, completed: 1 });
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(p, "class", "list-status svelte-e7ml1o");
    			add_location(p, file$2, 39, 8, 749);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_each_block(key_1, ctx) {
    	...
    	item.$on("update", handleUpdate);
    	item.$on("delete", handleDelete);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(37:4) {#each $items as item (item)}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "list svelte-e7ml1o");
    			add_location(div, file$2, 35, 0, 594);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*$items, handleUpdate, handleDelete*/ 1) {
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "container svelte-1x9tabf");
